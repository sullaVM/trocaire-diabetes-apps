...
CREATE TABLE `Patient_Logs` (
  ...
  KEY `Logs_fk_1` (`PatientID`),
  CONSTRAINT `Logs_fk_1` FOREIGN KEY (`PatientID`) REFERENCES `Patients` (`PatientID`) ON DELETE CASCADE
...
-- Dump completed on 2020-03-27 14:22:23
